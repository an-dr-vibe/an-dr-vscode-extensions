...
export function getWebviewLocalizedStrings() {
  return {
    ...
    repoInProgressCherryPick: vscode.l10n.t("Cherry-pick"),
    repoInProgressRevert: vscode.l10n.t("Revert"),
    repoInProgressWorkingTree: vscode.l10n.t("Working Tree/Index"),
    repoInProgressClean: vscode.l10n.t("clean"),
    repoInProgressChanged: vscode.l10n.t("{0} changed"),
    repoInProgressStaged: vscode.l10n.t("{0} staged"),
    repoInProgressConflicts: vscode.l10n.t("{0} conflicts"),
    repoInProgressUntracked: vscode.l10n.t("{0} untracked"),
    repoInProgressRebasing: vscode.l10n.t("rebasing {0}"),
    repoInProgressRebasingOnto: vscode.l10n.t("rebasing {0} onto {1}"),
    repoInProgressRebasingOntoOnly: vscode.l10n.t("rebasing onto {0}"),
    repoInProgressContinue: vscode.l10n.t("Continue"),
    ...
    branchPanelLocal: vscode.l10n.t("Local"),
    branchPanelRemote: vscode.l10n.t("Remote"),
