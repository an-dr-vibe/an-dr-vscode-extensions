...
describe('GitGraphView', () => {
	...
	describe('getHtmlForWebview', () => {
		...
		afterEach(() => {
			...
			expect(mockedWebviewPanel.panel.webview.html).toContain('<style>body{--git-graph-color0:#6ba2f2; --git-graph-color1:#ca3a7d; --git-graph-color2:#f3b33e; --git-graph-color3:#61aea6; --git-graph-color4:#ac70f7; } [data-color=\"0\"]{--git-graph-color:var(--git-graph-color0);} [data-color=\"1\"]{--git-graph-color:var(--git-graph-color1);} [data-color=\"2\"]{--git-graph-color:var(--git-graph-color2);} [data-color=\"3\"]{--git-graph-color:var(--git-graph-color3);} [data-color=\"4\"]{--git-graph-color:var(--git-graph-color4);} </style>');
		});
