...
export type RequestSendCommitRangeToCodeReview = {
  command: "sendCommitRangeToCodeReview";
  repository: string;
  from: string;
  to: string;
};
export type ResponseSendCommitRangeToCodeReview = {
  command: "sendCommitRangeToCodeReview";
  available: boolean;
};
...
export type RequestMessage =
  ...
  | RequestViewDiff
  | RequestSendCommitRangeToCodeReview;
...
export type ResponseMessage =
  ...
  | ResponseViewDiff
  | ResponseSendCommitRangeToCodeReview
  | ResponseRefresh;
