...
/**
 * Represents the users configuration of Commits Extension Settings.
 */
class Config {
	...
	constructor(repo?: string) {
		this.config = vscode.workspace.getConfiguration('an-dr-commits', repo ? vscode.Uri.file(repo) : undefined);
	}
	...
	/**
	 * Get the value of the `an-dr-commits.contextMenuActionsVisibility` Extension Setting.
	 */
	get contextMenuActionsVisibility(): ContextMenuActionsVisibility {
		...
		const config: ContextMenuActionsVisibility = {
			branch: { checkout: true, rename: true, delete: true, merge: true, rebase: true, push: true, viewIssue: true, createPullRequest: true, createArchive: true, selectInBranchesDropdown: true, unselectInBranchesDropdown: true, setUpstream: true, unsetUpstream: true, copyName: true },
	...
	/**
	 * Get the value of the `an-dr-commits.customBranchGlobPatterns` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `an-dr-commits.customEmojiShortcodeMappings` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `an-dr-commits.customPullRequestProviders` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `an-dr-commits.date.format` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `an-dr-commits.repository.commits.columnVisibility` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `an-dr-commits.dialog.merge.squashMessageFormat` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `an-dr-commits.dialog.pullBranch.squashMessageFormat` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `an-dr-commits.enhancedAccessibility` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `an-dr-commits.fileEncoding` Extension Setting.
	 */
	get fileEncoding() {
	...
	get graph(): GraphConfig {
		...
		return {
			...
			showTagsInActivityBar: !!this.config.get<boolean>('graph.showTagsInActivityBar', true)
		};
	}

	/**
	 * Get the value of the `an-dr-commits.integratedTerminalShell` Extension Setting.
	 */
	...
	/**
	 * Get the keybinding configuration from the `an-dr-commits.keyboardShortcut.*` Extension Settings.
	 */
	...
	/**
	 * Get the value of the `an-dr-commits.maxDepthOfRepoSearch` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `an-dr-commits.markdown` Extension Setting.
	 */
	get markdown() {
	...
	/**
	 * Get the value of the `an-dr-commits.logLevel` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `an-dr-commits.openNewTabEditorGroup` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `an-dr-commits.openToTheRepoOfTheActiveTextEditorDocument` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `an-dr-commits.repository.commits.fetchAvatars` Extension Setting.
	 */
	get fetchAvatars() {
	...
	/**
	 * Get the value of the `an-dr-commits.repository.commits.avatar.mode` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `an-dr-commits.repository.commits.avatar.size` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `an-dr-commits.repository.commits.avatar.shape` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `an-dr-commits.repository.commits.committedVisual` Extension Setting.
	 */
	get committedVisual() {
	...
	/**
	 * Get the value of the `an-dr-commits.repository.commits.initialLoad` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `an-dr-commits.repository.commits.loadMore` Extension Setting.
	 */
	get loadMoreCommits() {
	...
	/**
	 * Get the value of the `an-dr-commits.repository.commits.loadMoreAutomatically` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `an-dr-commits.repository.commits.order` Extension Setting.
	 */
	get commitOrder() {
	...
	/**
	 * Get the value of the `an-dr-commits.repository.commits.showSignatureStatus` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `an-dr-commits.repository.fetchAndPrune` Extension Setting.
	 */
	get fetchAndPrune() {
	...
	/**
	 * Get the value of the `an-dr-commits.repository.fetchAndPruneTags` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `an-dr-commits.repository.includeCommitsMentionedByReflogs` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `an-dr-commits.repository.showCommitsOnlyReferencedByTags` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `an-dr-commits.repository.showRemoteBranches` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `an-dr-commits.repository.showRemoteHeads` Extension Setting.
	 */
	get showRemoteHeads() {
	...
	/**
	 * Get the value of the `an-dr-commits.repository.showStashes` Extension Setting.
	 */
	get showStashes() {
	...
	/**
	 * Get the value of the `an-dr-commits.repository.showTags` Extension Setting.
	 */
	get showTags() {
	...
	/**
	 * Get the value of the `an-dr-commits.repository.showUncommittedChanges` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `an-dr-commits.repository.showUntrackedFiles` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `an-dr-commits.repository.sign.commits` Extension Setting.
	 */
	get signCommits() {
	...
	/**
	 * Get the value of the `an-dr-commits.repository.sign.tags` Extension Setting.
	 */
	get signTags() {
	...
	/**
	 * Get the value of the `an-dr-commits.repository.useMailmap` Extension Setting.
	 */
	get useMailmap() {
	...
	/**
	 * Get the value of the `an-dr-commits.repositoryDropdownOrder` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `an-dr-commits.retainContextWhenHidden` Extension Setting.
	 */
...
/**
 * Get a Config instance for retrieving the users configuration of Commits Extension Settings.
