...
describe('StatusBarItem', () => {
	...
	it('Should hide the Status Bar Item the extension setting an-dr-git.showStatusBarItem becomes disabled', () => {
		// Setup
		vscode.mockExtensionSettingReturnValue('showStatusBarItem', true);
	...
	it('Should ignore extension setting changes unrelated to an-dr-git.showStatusBarItem', () => {
		// Setup
		vscode.mockExtensionSettingReturnValue('showStatusBarItem', true);
