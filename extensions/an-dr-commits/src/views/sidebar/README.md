...
| `gitUtils.ts` | Git API working-tree helpers (`getHeadInfo`, `getWorkingTreeChanges`, `countChanges`, …) — reads directly from the vscode.git API rather than spawning git like `dataSource.ts` does |
