...
/**
 * Implements the Commits View's Find Widget.
 */
class FindWidget {
	 ...
	 * @param view The Commits View that the FindWidget is for.
	...
	public setColour(colour: string) {
		document.body.style.setProperty('--an-dr-commits-findMatch', colour);
		document.body.style.setProperty('--an-dr-commits-findMatchCommit', modifyColourOpacity(colour, 0.5));
	}
