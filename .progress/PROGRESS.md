...
- [ ] **MIT feature-parity migration** (verified) — Map the public an-dr-commits feature set and reimplement the missing functionality on an-dr-com-mit-s using only the MIT-derived foundation and independent code.
- [ ] **Compatibility contract** (planned) — Document the public command, configuration, view, and persisted-state compatibility contract for replacing an-dr-commits with the MIT foundation.
...
_Last updated: 2026-07-29T04:40:06.4673292Z_